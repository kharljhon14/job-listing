...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    description:
      '<p>Join our busy emergency department as a Consultant Emergency Medicine Physician. You will manage undifferentiated and acutely unwell patients across all age groups, lead resuscitation efforts, and support junior medical staff in a high-volume tertiary setting.</p>',
    requirements: [
  ...
  },
  {
    ...
    description:
      '<p>We are looking for a vocationally registered General Practitioner to join a well-established primary care practice in Queenstown. You will provide comprehensive, patient-centred care to a diverse community and have opportunities to develop special clinical interests.</p>',
    requirements: [
  ...
  },
  {
    ...
    description:
      '<p>An exciting opportunity exists for a Consultant Anaesthetist to join our perioperative team in Christchurch. You will provide anaesthetic services across a range of surgical specialties, participate in acute pain and obstetric anaesthesia, and contribute to departmental quality improvement.</p>',
    requirements: [
  ...
  },
  {
    ...
    description:
      '<p>We are recruiting a Consultant Psychiatrist to provide telehealth psychiatric services to patients across rural and regional New Zealand. You will conduct assessments, manage complex cases, and work collaboratively with community mental health teams and primary care providers.</p>',
    requirements: [
